...
describe("HeroSection", () => {
  ...
  it("should render hero section with primary button", () => {
    render(
      <HeroSection title="Hero Title" primaryButtonText="Primary Button" />
    );
  ...
  it("should render hero section with secondary button", () => {
    render(
      <HeroSection title="Hero Title" secondaryButtonText="Secondary Button" />
    );
  ...
  it("should render complete hero section with all props", () => {
    ...
    expect(
      screen.getByRole("heading", { name: /complete hero/i })
    ).toBeInTheDocument();
